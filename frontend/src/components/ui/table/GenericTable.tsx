...
const GenericTable = <T,>({
    ...
    */
    ...
    const [pagination, setPagination] = useState<PaginationState>({
        ...
        pageSize: 30      // número de elementos por página
    });
    ...
    */
    ...
    const handlerOnClickButtonFilter = (
        ...
        if (isVisibleFilterPopover === column.id) {
            ...
            console.log("filterInputValues[column.id]: ", filterInputValues[column.id]);
            if (!filterInputValues[column.id]) {
                console.log("entro3");
    ...
    const handlerOnClickButtonAddFilterColumn = (
        ...
        console.log("columnas filtradas aaaaaaaaaaaaaaaaaaa");
    ...
    // // imprimir todos los id de las colmnas 
    // table.getAllColumns().forEach((column) => {
    //     console.log(column.id);
    // });

    const valueColumnFilter = getValueFieldColumnFilter("carrier_id");
    console.log("carrier_id");
    console.log(valueColumnFilter);
                    ...
                    >
                        {
                            table?.getRowModel()?.rows?.length >= 0 && (
                                <GeneratorHeaderTable
                                    ...
                                    filterInputValues={filterInputValues} // valores clave-valor(columnId, valor del filtro)
                                    ...
                                    getValueFieldColumnFilter={getValueFieldColumnFilter} // columnas con filtros aplicados
