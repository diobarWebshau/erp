...
declare module '@tanstack/react-table' {
    interface ColumnMeta<TData extends unknown, TValue> {
        ...
        enumOptions?: Enum; // ✅ ya no da error y mantiene tipado
        hidden?: boolean;
