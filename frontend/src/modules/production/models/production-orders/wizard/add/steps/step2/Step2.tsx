...
const Step2 = ({
    ...
    const columnsInventoryInputs: ColumnDef<IInventoryInput>[] = useMemo(
        ...
        ], [[state.data.qty, state.data.product?.id, state.data.location?.id]
    ]);
    ...
    const {
        ...
        state.data.product?.id ?? null,
        state.data.location?.id ?? null
    );
    ...
    return (
        <div className={StyleModule.container}>
            ...
            <section className={StyleModule.bodySection}>
                ...
                >
                    {!loadingLocationsProducedProduct && (
                        <ValidationContainer validation={state.data.product ? null : "Debe seleccionar un producto"}>
                    ...
                    {!loadingLocationsProducedProduct && (
                        <ValidationContainer validation={state.data.location ? null : "Debe seleccionar una ubicacion"}>
                            <CustomSelectObject
