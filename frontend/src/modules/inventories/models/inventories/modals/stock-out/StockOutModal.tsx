...
interface IStockOutModalProps {
    onClose: Dispatch<SetStateAction<boolean>>
    onStockOut: (value: IPartialInventoryMovement) => void,
...
const StockOutModal = (
    ...
    const handleStockOut = (e: FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        if (
            quantity && quantity > 0
        ) {
