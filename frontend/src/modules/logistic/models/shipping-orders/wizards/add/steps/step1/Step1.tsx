...
import { update_shipping_order } from "../../../../context/shippingOrderActions";
import { useMemo } from "react";
import type { IPartialPurchasedOrder } from "../../../../../../../../models/purchased-orders/structure/types";
...
const Step1 = ({
    ...
    const purchase_order_products: IPartialPurchasedOrder[] =
    ...
    const [selectedPurchasedOrder, setSelectedPurchasedOrder] =
        useState<IPartialPurchasedOrder[]>(purchase_order_products);
    ...
    const handleOnClickNext = () => {
        if (selectedPurchasedOrder) {
            dispatch(update_shipping_order({
