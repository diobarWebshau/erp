                ...
                <div className={StyleModule.rightContent}>
                    ...
                    <div className={StyleModule.subContent}>
                        <div className={StyleModule.subContentItem}>
                            ...
                            <span>{`${purchasedOrder?.street}, ${purchasedOrder?.street_number}, ${purchasedOrder?.neighborhood}, C.P. ${purchasedOrder?.zip_code}`}</span>
                        </div>
                        <div className={`nunito-semibold ${StyleModule.subContentItem}`}>
                            ...
                            <span>{`${purchasedOrder?.shipping_city}, ${purchasedOrder?.shipping_state}, ${purchasedOrder?.shipping_country}`}</span>
                            <span>{`${purchasedOrder?.shipping_street}, ${purchasedOrder?.shipping_street_number}, ${purchasedOrder?.shipping_neighborhood}, C.P. ${purchasedOrder?.shipping_zip_code}`}</span>
                        </div>
                    </div>
                </div>
            </div>
