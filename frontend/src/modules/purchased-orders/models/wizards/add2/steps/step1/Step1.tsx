...
import { useModalAddState, useModalAddDispatch } from "../../context/modalAddHooks"
import { next_step, update_purchase_order } from "../../context/modalAddActions"
...
const Step1 = ({
    ...
    const [selectedSingle, setSelectedSingle] = useState<IPartialClient | null>(state.data.client ?? null);
    // ? ************ Funciones ************/
