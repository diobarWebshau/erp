...
import { PurchaseOrderProductModel, PurchasedOrderModel, ProductModel } from "../../../associations.js";
...
class PurchaseOrderProductController {
    ...
    static getByOrderCode = async (req, res, next) => {
    ...
    static create = async (req, res, next) => {
        ...
        try {
            ...
            if (!price) {
                res.status(200).json({
                    validation: "The product's selling price was not found"
                });
                return;
            }
            ...
            res.status(200).json({
                message: "PurchasedOrder-Product relationship created successfully"
            });
        }
        catch (error) {
            if (error instanceof Error) {
    ...
    static update = async (req, res, next) => {
        ...
        try {
            ...
            const props_products = updatedProduct
                ...
                : {};
            const [affectedRows] = await PurchaseOrderProductModel.update({ ...update_values, ...props_products }, { where: { id } });
            if (affectedRows === 0) {
                res.status(200).json({
            ...
            res.status(200).json({
                message: "PurchasedOrder-Product relationship"
