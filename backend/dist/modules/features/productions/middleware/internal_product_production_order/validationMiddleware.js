import { validatePartialSafeParseAsync, validateSafeParseAsync } from "../../schemas/InternalProductProductionOrder.schema.js";
const validateInternalProductProductionOrderMiddleware = async (req, res, next) => {
    const body = req.body;
