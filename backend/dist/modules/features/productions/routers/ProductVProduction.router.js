...
const createProductVProductionController = () => {
    const productRouter = Router();
    productRouter.get("/", ProductVProductionController.getAll);
    productRouter.get("/details/:id", ProductVProductionController.getProductDetails);
    ...
    productRouter.get("/product-discounts-ranges/:id", ProductVProductionController
        .getDiscountsRanges);
    productRouter.get("/input/:id", ProductVProductionController
        .getInputsOfProduct);
    productRouter.post("/:id/input/:input_id", ProductVProductionController
        .addInputToProduct);
    productRouter.delete("/:id/input/:input_id", ProductVProductionController
        .deleteInput);
    productRouter.patch("/:id/input/:input_id", ProductVProductionController
        .EditEquivalenceInProductInput);
    productRouter.get("/processes/:id", ProductVProductionController
        .getInputsOfProduct);
    productRouter.post("/:id/processes/:process_id", ProductVProductionController
        .assignProcessToProduct);
    productRouter.get("/best-location/:id", ProductVProductionController
        .getInfoBestLocationOfProduct);
    productRouter.delete("/:id/processes/:process_id", ProductVProductionController
        .deleteProcess);
