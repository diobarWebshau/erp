...
import validateInputsMiddleware from "../middleware/inputs/validationMiddleware.js";
import InputsController from "../controllers/Inputs.controller.js";
import { Router } from "express";
const createInputsRouter = () => {
    const InputRouter = Router();
    InputRouter.get("/", InputsController.getAll);
    ...
    InputRouter.patch(`/update-complete/:id`, uploadImageMiddleware, validateInputsMiddleware, InputsController.updateComplete);
    InputRouter.delete("/:id", InputsController.delete);
    return InputRouter;
};
