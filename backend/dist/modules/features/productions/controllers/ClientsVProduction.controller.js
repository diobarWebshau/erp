import ClientsControllers from "../../../core/clients/controllers/index.js";
import { ClientModel, ProductDiscountClientModel, ProductModel } from "../../../associations.js";
class ClientVProductionController extends ClientsControllers.ClientController {
    static getDiscountsOfClient = async (req, res, next) => {
        const { id } = req.params;
