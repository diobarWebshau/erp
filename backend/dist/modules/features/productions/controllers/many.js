...
import { ShippingOrderModel, PurchaseOrderProductModel, ShippingOrderPurchaseOrderProductModel, PurchasedOrderModel, PurchasedOrdersProductsLocationsProductionLinesModel, ProductionLineModel } from "../../../associations.js";
    ...
    static update = async (req, res, next) => {
        ...
        try {
            ...
            if (validateShippingOrderClientOnShippingOrder.length > 0) {
                ...
                const purchased_order_details = purchased_order_details_aux.purchase_order_product.purchase_order;
                ...
                const obtainClientPurchaseOrderProduct = await PurchaseOrderProductModel.findOne({
                    ...
                    include: [{
                            ...
                            where: {
                                purchase_order_product_id: relationship.purchase_order_product_id
                            },
                        }]
                });
                ...
                if (location_productionline_details.location_id !==
                    ...
                    res.status(200).json({
                        validation: "The purchase order product does not belong to the same "
            ...
            if (validateCreation) {
                res.status(200).json({
                    validate: "ShippingOrder-PurchaseOrderProduct relationship already exists"
                });
                return;
            }
