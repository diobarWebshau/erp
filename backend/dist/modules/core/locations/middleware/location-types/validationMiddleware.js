import { validatePartialSafeParseAsync, validateSafeParseAsync } from "../../schemas/LocationType.schema.js";
const validateLocationTypesMiddleware = async (req, res, next) => {
    const body = req.body;
