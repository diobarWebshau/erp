...
const createLocationsRouter = () => {
    ...
    locationRouter.post("/create-complete", validateLocationsMiddleware, LocationController.createComplete);
    locationRouter.patch("/:id", validateLocationsMiddleware, LocationController.update);
    locationRouter.patch("/update-complete/:id", LocationController.updateComplete);
