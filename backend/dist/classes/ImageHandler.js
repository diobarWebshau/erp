...
class ImageHandler {
    ...
    static removeImageIfExists = async (relativePath) => {
    ...
    static doesImageExist = async (relativePath) => {
        const imagePath = ImageHandler.resolveImagePath(relativePath);
        try {
            await fs.access(imagePath);
            return true;
    ...
    static convertToBase64 = async (relativePath) => {
        const imagePath = ImageHandler.resolveImagePath(relativePath);
    ...
    static removePathIfExists = async (relativePath) => {
