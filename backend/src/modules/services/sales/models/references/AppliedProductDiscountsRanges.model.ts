...
interface AppliedProductDiscountRangeCreateAttributes extends
    Optional<AppliedProductDiscountRangeAttributes,
        "id" | "created_at" | "updated_at"> { }

class AppliedProductDiscountRangeModel extends
    Model<AppliedProductDiscountRangeAttributes,
