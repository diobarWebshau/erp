...
import PurchasedOrderController
    from "../controllers/PurchasedOrders.controller.js";
...
const createPurchasedOrderRouter = (): Router => {
    ...
    purchasedOrderRouter.get("/ids",
        PurchasedOrderController.getByIds);
    ...
    purchasedOrderRouter.post("/",
        ...
        PurchasedOrderController.create);
    purchasedOrderRouter.patch("/:id",
        validatepurchasedOrdersMiddleware,
        PurchasedOrderController.update);
    purchasedOrderRouter.delete("/:id",
        PurchasedOrderController.delete);
