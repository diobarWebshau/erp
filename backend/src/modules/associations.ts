...
InventoryLocationItemModel.belongsTo(
    InventoryModel, {
...
PurchaseOrderProductModel.belongsTo(
    ProductModel, {
    foreignKey: "product_id",
    as: "product"
});
...
PurchaseOrderProductModel.hasOne(
    AppliedProductDiscountClientModel, {
...
PurchasedOrdersProductsLocationsProductionLinesModel.belongsTo(
    PurchaseOrderProductModel,
    {
        foreignKey: "purchase_order_product_id",
        as: "purchase_order_product",
...
LocationsProductionLinesModel.belongsTo(
    ProductionLineModel, {
    foreignKey: "production_line_id",
    as: "production_line",
    onDelete: "CASCADE"
...
InternalProductProductionOrderModel.hasOne(
    InternalProductionOrderLineProductModel, {
...
InternalProductionOrderLineProductModel.belongsTo(
    InternalProductProductionOrderModel, {
    foreignKey: "internal_product_production_order_id",
...
InventoryMovementModel.belongsTo(
    LocationModel, {
    foreignKey: "location_id",
    as: "location",
    onDelete: "SET NULL"
...
ProductionOrderModel.hasMany(
    ProductionModel, {
    foreignKey: "production_order_id",
    as: "productions"
});

ProductionModel.belongsTo(
    ProductionOrderModel, {
    foreignKey: "production_order_id",
    onDelete: "CASCADE",
    as: "production_order"
...
ClientModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName: string = "clients";
        const operation_name: string = 'update';
        const oldValues = instance.previous();
        const newValues = instance.dataValues;

        const [responseOperation, responseTable]:
            [OperationModel | null, TableModel | null] =
            await Promise.all([
        ...
        const operation: OperationAttributes | null =
            responseOperation?.toJSON() || null;
        const table: TableAttributes | null =
            responseTable?.toJSON() || null;
...
ClientModel.addHook("afterCreate",
    async (instance, options: any) => {
        const tableName: string = "clients";
        const operation_name: string = 'create';
        const newValues = instance.dataValues;
...
ClientModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName: string = "clients"
        const operation_name: string = 'delete';
...
ClientAddressesModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName: string = "clients_addresses";
        const operation_name: string = "update";
        const oldValues = instance.previous();
        const newValues = instance.dataValues;
...
ClientAddressesModel.addHook("afterCreate",
    async (instance, options: any) => {
        const tableName: string = "clients_addresses";
        const operation_name: string = "create";
        const newValues = instance.dataValues;
...
ClientAddressesModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName: string = "clients_addresses";
        const operation_name: string = "delete";
        const oldValues = instance.dataValues;
...
LocationModel.addHook("afterCreate",
    async (instance, options: any) => {
...
LocationModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "locations";
...
LocationModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "locations";
...
LocationTypeModel.addHook("afterCreate",
    async (instance, options: any) => {
...
LocationTypeModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "location_types";
        const operation_name = "update";
        const oldValues = instance.previous();
...
LocationTypeModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "location_types";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
LocationLocationTypeModel.addHook("afterCreate",
    async (instance, options: any) => {
...
LocationLocationTypeModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "locations_location_types";
        const operation_name = "update";
        const oldValues = instance.previous();
...
LocationLocationTypeModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "locations_location_types";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProductModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProductModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "products";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProductModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "products";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProductDiscountRangeModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProductDiscountRangeModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "product_discounts_ranges";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProductDiscountRangeModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "product_discounts_ranges";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
PermissionModel.addHook("afterCreate",
    async (instance, options: any) => {
...
PermissionModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "permissions";
        const operation_name = "update";
        const oldValues = instance.previous();
...
PermissionModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "permissions";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
RoleModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "roles";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
RolePermissionModel.addHook("afterCreate",
    async (instance, options: any) => {
...
RolePermissionModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "roles_permissions";
        const operation_name = "update";
        const oldValues = instance.previous();
...
RolePermissionModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "roles_permissions";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
UserModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "users";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
InventoryModel.addHook("afterCreate",
    async (instance, options: any) => {
...
InventoryModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "inventories";
        const operation_name = "update";
        const oldValues = instance.previous();
...
InventoryModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "inventories";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
InventoryLocationItemModel.addHook("afterCreate",
    async (instance, options: any) => {
...
InventoryLocationItemModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "inventories_locations_items";
        const operation_name = "update";
        const oldValues = instance.previous();
...
InventoryLocationItemModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "inventories_locations_items";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
InventoryTransferModel.addHook("afterCreate",
    async (instance, options: any) => {
...
InventoryTransferModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "inventory_transfers";
        const operation_name = "update";
        const oldValues = instance.previous();
...
InventoryTransferModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "inventory_transfers";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
CarrierModel.addHook("afterCreate",
    async (instance, options: any) => {
...
CarrierModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "carriers";
        const operation_name = "update";
        const oldValues = instance.previous();
...
CarrierModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "carriers";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ShippingOrderModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ShippingOrderModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "shipping_orders";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ShippingOrderModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "shipping_orders";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
PurchaseOrderProductModel.addHook("afterCreate",
    async (instance, options: any) => {
...
PurchaseOrderProductModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "purchased_orders_products";
        const operation_name = "update";
        const oldValues = instance.previous();
...
PurchaseOrderProductModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "purchased_orders_products";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
AppliedProductDiscountClientModel.addHook("afterCreate",
    async (instance, options: any) => {
...
AppliedProductDiscountClientModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "applied_product_discounts_client";
        const operation_name = "update";
        const oldValues = instance.previous();
...
AppliedProductDiscountClientModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "applied_product_discounts_client";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
AppliedProductDiscountRangeModel.addHook("afterCreate",
    async (instance, options: any) => {
...
AppliedProductDiscountRangeModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "applied_product_discounts_ranges";
        const operation_name = "update";
        const oldValues = instance.previous();
...
AppliedProductDiscountRangeModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "applied_product_discounts_ranges";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProductDiscountClientModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProductDiscountClientModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "product_discounts_clients";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProductDiscountClientModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "product_discounts_clients";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
PurchasedOrderModel.addHook("afterCreate",
    async (instance, options: any) => {
...
PurchasedOrderModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "purchased_orders";
        const operation_name = "update";
        const oldValues = instance.previous();
...
PurchasedOrderModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "purchased_orders";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
InputTypeModel.addHook("afterCreate",
    async (instance, options: any) => {
...
InputTypeModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "input_types";
        const operation_name = "update";
        const oldValues = instance.previous();
...
InputTypeModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "input_types";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProcessModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProcessModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "processes";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProcessModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "processes";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProductionLineModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProductionLineModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "production_lines";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProductionLineModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "production_lines";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
InternalProductProductionOrderModel.addHook("afterCreate",
    async (instance, options: any) => {
...
InternalProductProductionOrderModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "internal_product_production_orders";
        const operation_name = "update";
        const oldValues = instance.previous();
        ...
        const operation =
            operationRes?.toJSON() || null;
        const table =
            tableRes?.toJSON() || null;
...
InternalProductProductionOrderModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "internal_product_production_orders";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
InternalProductionOrderLineProductModel.addHook("afterCreate",
    async (instance, options: any) => {
...
InternalProductionOrderLineProductModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "internal_production_orders_lines_products";
        const operation_name = "update";
        const oldValues = instance.previous();
...
InternalProductionOrderLineProductModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "internal_production_orders_lines_products";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
LocationsProductionLinesModel.addHook("afterCreate",
    async (instance, options: any) => {
...
LocationsProductionLinesModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "locations_production_lines";
        const operation_name = "update";
        const oldValues = instance.previous();
...
LocationsProductionLinesModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "locations_production_lines";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProductInputModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProductInputModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "products_inputs";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProductInputModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "products_inputs";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProductionLineProductModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProductionLineProductModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "production_lines_products";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProductionLineProductModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "production_lines_products";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProductProcessModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProductProcessModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "products_processes";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProductProcessModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "products_processes";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
PurchasedOrdersProductsLocationsProductionLinesModel.addHook("afterCreate",
    async (instance, options: any) => {
        const tableName =
            "purchased_orders_products_locations_production_lines";
        const operation_name = "create";
        const newValues = instance.dataValues;
...
PurchasedOrdersProductsLocationsProductionLinesModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName =
            "purchased_orders_products_locations_production_lines";
        const operation_name = "update";
...
PurchasedOrdersProductsLocationsProductionLinesModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName =
            "purchased_orders_products_locations_production_lines";
        const operation_name = "delete";
...
ShippingOrderPurchaseOrderProductModel.addHook("afterCreate",
    async (instance, options: any) => {
        const tableName =
...
ShippingOrderPurchaseOrderProductModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName =
            "shipping_orders_purchased_order_products";
        const operation_name = "update";
...
ShippingOrderPurchaseOrderProductModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName =
            "shipping_orders_purchased_order_products";
        const operation_name = "delete";
...
InputModel.addHook("afterCreate",
    async (instance, options: any) => {
...
InputModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "inputs";
        const operation_name = "update";
        const oldValues = instance.previous();
...
InputModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "inputs";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
InventoryMovementModel.addHook("afterCreate",
    async (instance, options: any) => {
...
InventoryMovementModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "inventory_movements";
        const operation_name = "update";
        const oldValues = instance.previous();
...
InventoryMovementModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "inventory_movements";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProductionOrderModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProductionOrderModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "production_orders";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProductionOrderModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "production_orders";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
ProductionModel.addHook("afterCreate",
    async (instance, options: any) => {
...
ProductionModel.addHook("afterUpdate",
    async (instance, options: any) => {
        const tableName = "productions";
        const operation_name = "update";
        const oldValues = instance.previous();
...
ProductionModel.addHook("afterDestroy",
    async (instance, options: any) => {
        const tableName = "productions";
        const operation_name = "delete";
        const oldValues = instance.dataValues;
...
sequelize.sync({ force: false })
    .then(() => {
        console.log(
            "Modelos features e integration "
            + "sincronizados correctamente");
    })
    .catch(err => {
        console.error(
            "Error al sincronizar los modelos:",
            err
        );
    });
...
export {
    ...
    ProductDiscountRangeModel, ProductModel,
    LocationLocationTypeModel, LocationModel,
    LocationTypeModel,
    /* SERVICE'S MODULES */
    UserModel, PermissionModel,
    RoleModel, RolePermissionModel,
    ...
    ProductDiscountClientModel,
    PurchasedOrderModel,
    LogModel, TableModel, OperationModel,
    /* INTEGRATION MODULES */
    ProductionModel,
    ProductionOrderModel,
    PurchasedOrdersProductsLocationsProductionLinesModel,
