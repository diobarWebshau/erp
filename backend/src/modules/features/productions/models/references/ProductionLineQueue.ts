...
interface ProductionLineQueueCreateAttributes
    extends Optional<ProductionLineQueueAttributes, "id" | "position" | "created_at"> {}

class ProductionLineQueueModel
    extends Model<ProductionLineQueueAttributes, ProductionLineQueueCreateAttributes>
{
