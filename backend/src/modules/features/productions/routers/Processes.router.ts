import validateProcessesMiddleware
    from "../middleware/processes/validationMiddleware.js";
import processesController
    from "../controllers/Processes.controller.js";
import { Router } from "express";

const createProcessesRouter = (): Router => {
    ...
    processesRouter.post("/",
        validateProcessesMiddleware,
        processesController.create);
    processesRouter.patch("/:id",
        validateProcessesMiddleware,
        processesController.update);
    processesRouter.delete("/:id",
