import validateProductionLinesMiddleware
...
const createProductionLineRouter = (): Router => {
    ...
    productionLineRouter.get("/",
        ProductionLinesController.getAll);
    productionLineRouter.get("/id/:id",
        ProductionLinesController.getById);
    productionLineRouter.get("/details/:id",
        ProductionLinesController.getProductionLineDetails);
    productionLineRouter.get("/name/:name",
        ProductionLinesController.getByName);
    ...
    productionLineRouter.delete("/:id",
        ProductionLinesController.delete);
    productionLineRouter.get("/:id/products",
        ProductionLinesController
            .getProductsOnProductionLine
    );
    productionLineRouter.post("/:id/products/",
        ProductionLinesController.addProduct
    );
    productionLineRouter.delete("/:id/products/:product_id",
        ProductionLinesController.deleteProduct
    );
